    ...
    >
      ...
      <div class="row">
        ...
        <div class="col-md-6 d-flex flex-column justify-content-center">
          ...
          <form class="sized-form"  method="POST" action="/ag/{{$stc->id}}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3 form-floating">
              ...
              <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button class="btn btn-primary me-md-2" type="submit">valider</button>
                <a class="btn btn-danger" href="/as/home">annuler</a>
              </div>
          </form>
        </div>
      </div>
